...
public class controllerRelatorioVendas implements Initializable {
    ...
    @FXML
    private TableColumn<Vendas, String> columnNome;
    ...
    void OnbtnPesquisar(ActionEvent event) {
        arrayVendas = FXCollections.observableArrayList(vendaDAO.search(labelpesquisar.getText())); // Implementar método search no DAO
